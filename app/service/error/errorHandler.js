...
const errorHandler = {
     ...
     */
    manage(err,req,res,_){ // expess détecte 4 paramètres et va donc entrer dans cettes méthodes quand il y a une exception de levée
    ...
    async logError(err,url) {
        ...
        try{
            ...
            const columnsString = 'Date'+separator+'Url'+separator+'Message'+separator+'Stacktrace\n';
            // je crèe mon fichier
        ...
        try{
            ...
            const line = new Date()+separator+url+separator+err.message+separator+stackFormated+"\n";
...
function getFilePath(){
    ...
    if (month < 10) { // je vérifie si c'est <10 pour ajouter un 0 devant
        month = "0" + month;
    }
